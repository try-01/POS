...
/**
 * Formatter khusus ESC/POS. Body struk (total, diskon, kembalian, dsb.) sekarang
 * bersumber tunggal dari [ReceiptManager.buildLines] — file ini hanya menambahkan
 * logo (spesifik format printer thermal) dan menentukan lebar divider sesuai
 * karakter-per-baris printer yang aktif.
 */
